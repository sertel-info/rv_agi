<?php
   ...
   // if (!class_exists('AGI_AsteriskManager'))
    //{
   //     require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'phpagi-asmanager.2.2.php');
   // }
   
 //    $ini = parse_ini_file('/var/lib/asterisk/agi-bin/config.ini',true);
	// $ddd_sistema = $ini['sertelipbx']['ddd'];
	// $pref_central = $ini['sertelipbx']['pref_central'];
	// $ramal_central = $ini['sertelipbx']['ramal_central'];

	/**
	 * Conexão Com Mysql
	 * Incluido por André Luiz em 19/04/2010
	 *
	 */
	 ...
	 *
	 */
	// require_once('/var/lib/asterisk/agi-bin/libs/funcoes.php');
	// /**/
	//  $FUNCOES = new CONEXAO();
 //    $conexao = $FUNCOES->abreConexao();
	// /**/
